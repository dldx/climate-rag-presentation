...
>
	...
	<Slide class="h-full place-content-center place-items-center">
		<Transition visible enter="fade-enter">
			<p class="mt-5 block max-w-[80ch] border-l border-l-[var(--r-heading-color)] pl-5 text-left">
				<code class="text-xs xl:text-lg">
		...
		<Transition
			...
			order={1}
		>
			<div class=" m-4 grid grid-cols-3 items-stretch gap-3 xl:m-16">
	...
	>
		<Transition visible>
			<h1 class="static text-4xl !text-yellow-300 xl:text-7xl">The Solution</h1>
		</Transition>
		<Transition
			enter="enter"
			class="hidden"
