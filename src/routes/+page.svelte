	...
	<Slide class="h-full place-content-center place-items-center" in={() => (layout = '')}>
		...
		>
			<div class="{layout} m-16 flex flex-col place-content-center place-items-center">
				<div class="{visibility} flex flex-col place-content-center place-items-center text-xl max-w-[50ch]">
					...
					<Transition enter="fade-enter" class="mt-16">
						This is a modern technique that combines the benefits of a database of
						verifiable information, with the flexibility of a large language generative model.
					</Transition>
				</div>
				<Transition enter="fade-enter" do={() => {visibility = "hidden"}} undo={() => {visibility = ""}}>
					<img src="./rag-pipeline.svg" height=800 alt="Flow chart showing RAG pipeline from start to finish"/>
				</Transition>
			</div>
		</Transition>
	</Slide>
